...
\captionsetup{type=figure}
\centering
\subcaptionbox{1. Filter top $k$}[44mm]{\input{figures/fig_1_8a.tex}}\hfill
\subcaptionbox{2. Add prior}[44mm]{\input{figures/fig_1_8b.tex}}\hfill
\subcaptionbox{3. Prior $\cdot$ UCB1}[44mm]{\input{figures/fig_1_8c.tex}}
...
\captionsetup{type=figure}
\centering
\subcaptionbox{4. Finite at zero}{\input{figures/fig_1_8d.tex}}\qquad
\subcaptionbox{5. $\sqrt{N}$ growth}{\input{figures/fig_1_8e.tex}}\\[2ex]
\input{figures/fig_1_8_box.tex}
...
\captionsetup{type=figure}
\centering
\subcaptionbox{Why $Q$ is an average}{\input{figures/fig_1_11a.tex}}\qquad
\subcaptionbox{Why $U$ is built this way}{\input{figures/fig_1_11b.tex}}\\[2ex]
\subcaptionbox{Why $S=Q+U$ is a sum}{\input{figures/fig_1_11c.tex}}\qquad
\subcaptionbox{Why $c_{\mathrm{puct}}$ grows}{\input{figures/fig_1_11d.tex}}
...
\begin{pitfall}[Where People Go Wrong: One Value Per Position, Not Per Move]
A common misreading assumes the neural network outputs individual value evaluations for candidate moves:
\begin{center}
\begin{minipage}{\linewidth}
\captionsetup{type=figure}
\centering
\subcaptionbox{The Misreading}{\input{figures/fig_1_4a.tex}}\qquad
\subcaptionbox{What Actually Comes Back}{\input{figures/fig_1_4b.tex}}
...
\subcaptionbox{4. Backpropagation}{\input{figures/fig_1_6d.tex}}
