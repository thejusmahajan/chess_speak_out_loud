...
**1. `briefs/2026-08-19_knowledge-base-audit.md` — ACTIVE ← do this one**
Adversarial audit of the doctrine and study documents for errors, contradictions, stale claims
and definition drift. Reading and reasoning only — writes one report, changes nothing else.
Blocks the trainer below.

**2. `briefs/2026-08-19_knowledge-trainer-build.md` — BLOCKED**
The spaced-repetition interview trainer. Do not start until the audit above is delivered **and
audited** — its content is drawn from documents currently suspected stale.
...
| `2026-08-19_knowledge-base-audit` | chess_speak_out_loud | design/audit | **ACTIVE** | — | — |
| `2026-08-19_knowledge-trainer-build` | chess_speak_out_loud | implementation | **BLOCKED** | — | — |
