...
The spaced-repetition interview trainer. Still blocked: the audit found documents that would
teach false things, and the leader's doctrine corrections (`…_AUDIT.md` §6) are not yet applied.
When unblocked, three extra constraints from that audit §7 apply.
